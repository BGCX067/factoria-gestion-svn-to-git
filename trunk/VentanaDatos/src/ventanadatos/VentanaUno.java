...
public void cargarCaja(String parametro){
    this.txtUno.setText("holaaaaaaaaaaaa");
    VentanaUno.this.txtUno.setText("holoooooooooooooo");
    System.out.println("el parametro de entrada " + parametro);
};
}
